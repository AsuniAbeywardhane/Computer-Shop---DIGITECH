...
<div id="myModal" class="modal">
 ...
 <center>
    ...
    <center>
    <img src="image/giphy.gif" width="80px">
    <h1 style="color:#413839;">Error!</h1>
    <p style="color: #488AC7;">Error While Saving Data</p>
    <a href=" signup.php"><input type="button" name="link" value="Retry" style="color: white; width: 80px; height: 30px;  border:none; background-color: #373866; border-radius: 5px; box-shadow: 2px 5px #888888;"></a>
    </center>
  </div>
 </center>
