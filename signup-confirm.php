<!DOCTYPE html>
<html>
<head><title>www.digicomputers.lk</title>
...
<div id="myModal" class="modal">
 ...
 <center>
    ...
    <center>
    <img src="image/tenor.gif" width="80px">
    <h1 style="color:#413839;">Good job!</h1>
    <p style="color: #488AC7;">Successfully Saved Your Data.</p>
    <a href=" login.php"><input type="button" name="link" value="OK"  style="color: white; width: 80px; height: 30px;  border:none; background-color: #373866; border-radius: 5px; box-shadow: 2px 5px #888888;"></a>
    </center>
  </div>
 </center>
